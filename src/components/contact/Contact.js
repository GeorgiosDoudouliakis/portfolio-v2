    ...
    return (
        <motion.section id="contact" className="text-center py-10 px-6 bg-zinc-900 md:py-14 md:px-0 lg:py-16" initial={{ opacity: 0 }}
            ...
            <div className="flex justify-center text-3xl mb-8">
                ...
                <h2 className="text-orange-500">Contact</h2>
            </div>
            <p className="text-white w-80 mx-auto mb-8 md:w-96 xl:text-lg">If you want to discuss something you can text me anytime. I will try to respond as soon as possible!</p>
